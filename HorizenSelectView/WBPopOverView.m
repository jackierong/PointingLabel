...
- (void)drawRect:(CGRect)rect
{
    ...
    else if (_direction==WBArrowDirectionUp3)
    {
        ...
        CGContextAddLineToPoint(context, startX -30, startY+20);
...
-(void)popView
{
    ...
    {
        self.backView.frame = CGRectMake(self.origin.x, self.origin.y+20, 0, 0);
        [UIView animateWithDuration:0.2 animations:^{
            self.alpha = 1;
            self.backView.frame = CGRectMake(self.origin.x+30, self.origin.y+20, -self.width,self. height);
